...
export function formatNewCoinReport(rows, delivery, settings, trigger, timeframe = "8H") {
  ...
  if (!delivery.delivered.length && settings.telegram.sendNoSignalSummary) {
    lines.push(trigger === "schedule" ? "Không có tín hiệu BUY/SELL mới trên nến 8H vừa đóng." : "Không có tín hiệu BUY/SELL trên nến 8H gần nhất.");
  }
