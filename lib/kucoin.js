...
export async function fetchKucoinClosedCandles(symbol, timeframe = "1D", limit = 500) {
  ...
  }).filter(item => item.closeTime < now).sort((a, b) => a.openTime - b.openTime), "KuCoin", symbol);
}
